...
public class TestListener1 implements IExecutionListener, ITestListener, IInvokedMethodListener {
    ...
    public void capture(String methodName){
        ...
        try {
            ...
            FileUtils.copyFile(source, new File("./Screenshots/"+methodName + System.currentTimeMillis() +".png"));
